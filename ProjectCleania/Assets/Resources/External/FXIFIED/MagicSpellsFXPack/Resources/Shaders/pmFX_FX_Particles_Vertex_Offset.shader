...
Shader "pmFX/FX/FX_Particles_Vertex_Offset"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += float3( ( ( _Scale * ( appendResult31 * temp_output_18_0 ) ) * tex2Dlod( _TextureSample0, float4( uv_TextureSample0, 0, 0.0) ).r ) ,  0.0 );
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18908
492;480;748;529;715.4452;-32.4691;1.3;True;False
...
ASEEND*/
//CHKSM=B821269913E9EB5028F1E90EAE2CD4DD14A60298