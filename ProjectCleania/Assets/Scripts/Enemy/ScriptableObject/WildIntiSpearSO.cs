...
public class WildIntiSpearSO : EnemySkillSO
{
    ...
    [Header("출혈 찌르기 확률")]
    public float BloodChance;
    public float GetBloodChance() { return BloodChance; }

    [Header("출혈 디버프 시간")]
    public float BloodTime;
    public float GetBloodTime() { return BloodTime; }
}
